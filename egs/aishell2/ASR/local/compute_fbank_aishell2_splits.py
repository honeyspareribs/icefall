...
def compute_fbank_aishell2_splits(args):
    ...
    for i in range(start, stop):
        ...
        raw_cuts_path = output_dir / f"aishell2_cuts_{subset}_raw.{idx}.jsonl.gz"
...
def main():
    ...
    log_filename = "log-compute_fbank_aishell2_splits"
    ...
    compute_fbank_aishell2_splits(args)
